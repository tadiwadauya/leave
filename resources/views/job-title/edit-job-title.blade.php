        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header text-white">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="{{ url('/jobtitles/' . $title->id) }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="Back to Job Title">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['jobtitles.update', $title->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('jobtitle') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('jobtitle', $title->jobtitle, array('id' => 'jobtitle', 'class' => 'form-control', 'placeholder' => 'e.g. Foromani')) !!}
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <select class="custom-select form-control dynamic" name="department" id="department">
                                        <option value="{{ $title->department }} ">{{ $title->department }}</option>
                        ...
                        {!! Form::button('Update Job Title', array('class' => 'btn btn-primary margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>
