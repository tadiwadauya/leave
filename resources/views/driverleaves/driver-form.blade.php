...
$userInfo = \App\Models\Driver::where('paynumber', $leave->paynumber )->first();;
...
<table border="1" width="100%" style="font-family: Arial; border-collapse: collapse; font-size: 10pt;" cellpadding="5">
    <tr>
        ...
        <td style="width: 60%;">DEPARTMENT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong> Operations</strong></td>
        <td style="width: 17%;">PAY NO</td>
    </tr>

    <tr>
        <td>NAME</td>
        <td style="text-align: center;"><strong>{{$userInfo->full_name}}</strong></td>
    ...
    <tr>
        <td>CONTACT NO</td>
        <td >CELL NO <strong>{{' '.$userInfo->cell_no}}</strong></td>
        <td></td>
    </tr>
</table>
<br/>
...
<table border="1" width="100%" style="font-family: Arial; border-collapse: collapse; font-size: 10pt;">
    ...
    <tr>
        ...
        <td style="text-align: center;">@if($leave->type_of_leave =='Cash in Lieu of Leave (CILL)'){{$userInfo->leave_days}} @else N/A @endif</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
    </tr>
    ...
    <tr>
        ...
        <td style="text-align: center;">@if($leave->type_of_leave =='Cash in Lieu of Leave (CILL)'){{$leave->days_taken}} @else N/A @endif</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
    </tr>
    ...
    <tr>
        <td>VALUE</td>
        <td style="text-align: center;">@if($leave->type_of_leave =='Cash in Lieu of Leave (CILL)')  @else N/A @endif</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
    </tr>
    ...
    <tr>
        ...
        <td style="text-align: center;">@if($leave->type_of_leave =='Cash in Lieu of Leave (CILL)'){{$userInfo->leave_days - $leave->days_taken}}  @else N/A @endif</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
        <td style="text-align: center;">N/A</td>
    </tr>
