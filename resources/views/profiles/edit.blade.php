                                            ...
                                            <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="tab-pane fade edit-settings-tab" role="tabpanel" aria-labelledby="edit-settings-tab">
                                                    ...
                                                    <div class="pr-3 pl-2 form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
                                                        {!! Form::label('email', 'Whelson Work Email', array('class' => 'col-md-3 control-label')); !!}
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                    ...
                                                    <div class="pr-3 pl-2 form-group has-feedback row {{ $errors->has('mobile') ? ' has-error ' : '' }}">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                {!! Form::text('mobile', $user->mobile, array('id' => 'mobile', 'class' => 'form-control', 'placeholder' => 'Your Mobile Number')) !!}
                                                                <div class="input-group-append">
                                                    ...
                                                    <div class="pr-3 pl-2 form-group has-feedback row {{ $errors->has('address') ? ' has-error ' : '' }}">
                                                        {!! Form::label('address', 'Home Address', array('class' => 'col-md-3 control-label')); !!}
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                {!! Form::text('address', $user->address, array('id' => 'address', 'class' => 'form-control', 'placeholder' => 'Your Physical Home Address')) !!}
                                                                <div class="input-group-append">
