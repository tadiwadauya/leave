                            ...
                            <table class="table table-striped table-sm data-table">
                                ...
                                @foreach($leaves as $leave)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('/leaves/approve/' . $leave->id) }}" data-toggle="tooltip" title="Approve Leave">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-danger btn-block" href="{{ URL::to('/leaves/reject/' . $leave->id) }}" data-toggle="tooltip" title="Reject Leave">
