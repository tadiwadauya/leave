                                ...
                                <tbody id="users_table">
                                    @foreach ($leaves as $leave)
                                        <tr>
                                            ...
                                            <td><a href="{{ url('leaves/' . $leave->id) }}"> {{ $leave->days_taken }}</a>
                                            </td>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success btn-block"
                                                    href="{{ URL::to('/leaves/approve/' . $leave->id) }}"
                                                    data-toggle="tooltip" title="Approve Leave">
                                                    <i class="fa fa-check fa-fw" aria-hidden="true"></i> <span
                                                        class="hidden-xs hidden-sm">Approve</span><span
