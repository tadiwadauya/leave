            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => 'records.leave', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        @if(isset($leaves))
                            <strong>Showing Leave Records from {{$from}} to {{$to}}</strong>
