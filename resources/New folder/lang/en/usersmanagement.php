...
return [
    ...
    'users-table' => [
        ...
        'dept_caption'   => '{1} :userscount department total|[2,*] :userscount total departments',
        'leave_caption'   => '{1} :userscount leave total|[2,*] :userscount total leave requests',
        'recovery_caption'   => '{1} :userscount recovery form total|[2,*] :userscount total recovery forms',
        'rfaccount_caption'   => '{1} :userscount account total|[2,*] :userscount total accounts',
        'rfa_caption'   => '{1} :userscount transaction total|[2,*] :userscount total transactions',
        'id'        => 'ID',
        'name'      => 'Username',
        'fname'     => 'First Name',
        'lname'     => 'Last Name',
