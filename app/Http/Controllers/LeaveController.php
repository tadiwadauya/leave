...
class LeaveController extends Controller
{
    ...
    public function pending()
    {
        ...
        return View('leaves.pending-leave', compact('leaves'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->type_of_leave == 'Annual' or $request->type_of_leave == 'Cash in Lieu of Leave (CILL)' or $request->type_of_leave == 'Off Day' or $request->type_of_leave == 'Sick' or $request->type_of_leave == 'Maternity') {
            ...
            $holidays = array(
                '2022-01-01', '2022-02-21', '2022-04-15', '2022-04-16', '2022-04-17', '2022-04-18', '2022-05-02', '2020-05-25', '2022-08-10', '2022-09-11',
    ...
    public function resendEmail($id)
    {
        ...
        // $user = User::where('paynumber', $leave->paynumber)->get();

        // $managers = DB::select('select * from users where paynumber in (select manager from departments)');
        // $asst_managers = DB::select('select * from users where paynumber in (select asst_manager from departments)');
        // $directors = User::where('position', "Finance Director")
        //     ->orWhere('position', "Technical Director")
        //     ->orWhere('position', "Managing Director")->get();
        ...
        // if ($directors or $managers or $asst_managers) { // you can pass an id or slug
        //     $managerDirectorCheck = true;
        // } else {
        //     $managerDirectorCheck = false;
        // }
        ...
        // if ($managerDirectorCheck) {
        //     $appliya = User::where('paynumber', '=', $leave->paynumber)->first();
        ...
        //             })
        //             ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'departments.department')
        //             ->where('departments.department', '=', $leave->department)
        //             ->get();
        //     } else {
        ...
        //         if (in_array($leave->department, $fdDepts1)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Finance Director')
        ...
        //                 ->get();
        //             //Nathi
        //         } elseif (in_array($leave->department, $dirDept1)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Managing Director')
        //                 ->orwhere('users.position', '=', 'Technical Director')
        //                 ->get();
        //         } elseif (in_array($leave->department, $dirDept2)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Managing Director')
        //                 ->orwhere('users.position', '=', 'Finance Director')
        //                 ->get();
        //         } elseif (in_array($leave->department, $dirDept3)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Technical Director')
        //                 ->orwhere('users.position', '=', 'Finance Director')
        //                 ->get();
        //         } elseif (in_array($leave->department, $techdDepts)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Technical Director')
        //                 ->get();
        //         } elseif (in_array($leave->department, $opsHod)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Operations Manager')
        //                 ->get();
        //         } elseif (in_array($leave->department, $engHod)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Engineering Manager')
        //                 ->get();
        //         } elseif (in_array($leave->department, $accHod)) {
        //             $approvers = DB::table('users')
        //                 ->select('users.paynumber', 'users.first_name', 'users.last_name', 'users.email', 'users.department')
        //                 ->where('users.position', '=', 'Finance Manager')
        //                 ->get();
        //         } elseif (in_array($leave->department, $mdDepts)) {
        //             $approvers = DB::table('users')
        //                 ->join('role_user', function ($join) {
        //                     $join->on('users.id', '=', 'role_user.user_id');
        //                 })
        ...
        try {
            foreach ($approvers as $authorizer) {
                $applicant = User::where('paynumber', '=', $leave->paynumber)->first(); //Systems Applications Administrator Finance Manager
                ...
                return redirect()->back()->with('success', 'Email was successfully resent!');
            }
        } catch (\Exception $exception) {
            echo 'Error - ' . $exception;
        }
